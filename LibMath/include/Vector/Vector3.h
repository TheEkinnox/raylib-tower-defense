...
namespace LibMath
{
	...
	public:
		...
		Vector3&		operator-=(Vector3 const&);						// subtraction component wise
	...
	bool			operator==(Vector3 const&, Vector3 const&);			// Vector3{ 1 } == Vector3::one()				// true					// return whether 2 vectors have the same component
